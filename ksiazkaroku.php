...
<?php
  $sql = "SELECT ksiazka.ID, ksiazka.tytul, ksiazka.miniaturka_okladki, ksiazka.opis, ksiazka.ISBN, ksiazka.autor, autor.lp, autor.imie, autor.nazwisko FROM ksiazka  INNER JOIN autor ON ksiazka.autor = autor.lp WHERE ksiazka.ksiazkaroku = 1 limit 1";
